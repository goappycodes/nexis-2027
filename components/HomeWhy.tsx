        ...
        <div className="max-w-3xl">
          ...
          <Reveal delay={80}>
            <h2 className="display balance mt-5 text-[clamp(2rem,4.6vw,3.5rem)]">
              ...
              <span className="serif-em text-crimson">school</span>.
            </h2>
          </Reveal>
          <Reveal delay={140}>
            <p className="mt-6 max-w-xl text-[1.02rem] leading-relaxed text-white/70">
              We threw out the lecture-first playbook. Here, you learn business
              the way it&rsquo;s actually done — building, selling, consulting and
              shipping from your very first semester.
            </p>
          </Reveal>
        </div>

        <div className="mt-10 sm:mt-16 grid grid-cols-2 gap-px overflow-hidden rounded-[4px] border border-white/15 bg-white/15 lg:grid-cols-4">
          {WHY_NEXIS.map((w, i) => (
            <Reveal
              key={w.t}
              delay={i * 80}

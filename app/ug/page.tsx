...
import StudentCarousel from "@/components/StudentStrip";
...
/* ---- Content & layout mirror nexisschool.com/ug (kept local to /ug) ---- */
...
const DIM: Record<string, [number, number]> = {
  "/images/ug/program-overview.jpg": [1920, 1080],
  "/images/ug/highlight-faculty.jpg": [1280, 720],
  "/images/ug/highlight-curriculum.jpg": [1600, 893],
    ...
    <main className="relative font-poppins lp-poppins">
      ...
      <section className="bg-paper text-ink">
        ...
        <div className="relative mt-4 pb-10 sm:mt-6 sm:pb-14">
          ...
          {/* Right edge only — the first card stays flush with the container. */}
          <div
            aria-hidden
            className="pointer-events-none absolute inset-y-0 right-0 w-14 bg-gradient-to-l from-paper via-paper/80 to-transparent sm:w-24"
          />
        </div>
      </section>

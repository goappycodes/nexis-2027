...
const ROUTES: { path: string; priority: number }[] = [
  ...
  { path: "/ug/highlights", priority: 0.8 },
  { path: "/ug/curriculum", priority: 0.8 },
  { path: "/ug/admissions-fees", priority: 0.8 },
  { path: "/ug/career-prospect", priority: 0.8 },
  { path: "/ug/student-life", priority: 0.8 },
  { path: "/ug/founding-batch", priority: 0.8 },
  ...
  { path: "/ug/life-at-nexis", priority: 0.5 },
  { path: "/ug/career-prospects", priority: 0.5 },
